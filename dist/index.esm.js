...
var StyledButton = styled.button(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  align-items: center;\n  background: ", ";\n  border: ", ";\n  border-radius: 7px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-size: 15px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  min-width: 64px;\n  line-height: 1.75;\n  justify-content: center;\n  transition: background-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, box-shadow 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, border-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;\n  outline: 0;\n  padding: ", ";\n  opacity: ", ";\n\n  &:hover {\n    background-color: rgb(190, 17, 105);\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background: ", ";\n  border: ", ";\n  border-radius: 7px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-size: 15px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  min-width: 64px;\n  line-height: 1.75;\n  justify-content: center;\n  transition: background-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, box-shadow 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, border-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;\n  outline: 0;\n  padding: ", ";\n  opacity: ", ";\n\n  &:hover {\n    background-color: rgb(190, 17, 105);\n  }\n\n  ", "\n  ", "\n  ", "\n"])), getButtonVariantProp("background"), getButtonVariantProp("border"), getButtonVariantProp("boxShadow"), getButtonVariantProp("color"), function (_a) {
    ...
    var size = _a.size;
    return (size === "sm" ? "3px 30px" : "3px 30px");
}, function (_a) {
...
var Icon$L = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/chipz/logo.png" })));
};
...
var Icon$J = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 16 2" }, props),
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 300 100" }, props),
        React.createElement("image", { width: "300", height: "100", href: isDark ? '/chipz/chipz-logo-dark.png' : '/chipz/chipz-logo-white.png' })));
};
...
var Icon$g = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { id: "telegram-1", d: "M18.384,22.779c0.322,0.228 0.737,0.285 1.107,0.145c0.37,-0.141 0.642,-0.457 0.724,-0.84c0.869,-4.084 2.977,-14.421 3.768,-18.136c0.06,-0.28 -0.04,-0.571 -0.26,-0.758c-0.22,-0.187 -0.525,-0.241 -0.797,-0.14c-4.193,1.552 -17.106,6.397 -22.384,8.35c-0.335,0.124 -0.553,0.446 -0.542,0.799c0.012,0.354 0.25,0.661 0.593,0.764c2.367,0.708 5.474,1.693 5.474,1.693c0,0 1.452,4.385 2.209,6.615c0.095,0.28 0.314,0.5 0.603,0.576c0.288,0.075 0.596,-0.004 0.811,-0.207c1.216,-1.148 3.096,-2.923 3.096,-2.923c0,0 3.572,2.619 5.598,4.062Zm-11.01,-8.677l1.679,5.538l0.373,-3.507c0,0 6.487,-5.851 10.185,-9.186c0.108,-0.098 0.123,-0.262 0.033,-0.377c-0.089,-0.115 -0.253,-0.142 -0.376,-0.064c-4.286,2.737 -11.894,7.596 -11.894,7.596Z" })));
};
...
var LinkLabel = styled.div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"], ["\n  color: ", ";\n  transition: color 0.4s;\n  flex-grow: 1;\n"])), function (_a) {
    ...
    return (isPushed ? theme.colors.textwhite : "transparent");
});
var MenuEntry = styled.div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  padding: ", ";\n  margin-bottom: 4px;\n  font-family: Roboto, sans-serif !important;\n  font-size: 0.875rem;\n  line-height: 1.75;\n  color: #ffffff;\n  background-color: ", ";\n  box-shadow: ", ";\n  \n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  padding: ", ";\n  margin-bottom: 4px;\n  font-family: Roboto, sans-serif !important;\n  font-size: 0.875rem;\n  line-height: 1.75;\n  color: #ffffff;\n  background-color: ", ";\n  box-shadow: ", ";\n  \n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), function (_a) {
    var secondary = _a.secondary;
    return (secondary ? "10px 8px 10px 24px" : "10px 8px 10px 24px");
}, function (_a) {
    var isActive = _a.isActive;
    return (isActive ? 'rgba(206, 33, 121, 0.1)' : null);
}, function (_a) {
    ...
    var isActive = _a.isActive;
    return (isActive ? 'rgba(33, 150, 243, 0.04)' : null);
...
var PanelBody = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, isMobile = _a.isMobile, links = _a.links, priceLink = _a.priceLink, cakePriceUsd = _a.cakePriceUsd;
...
var CHIPZBOTTOM = styled.p(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  cursor: pointer;\n  font-family: -apple-system,BlinkMacSystemFont,\"Segoe UI\",\"Roboto\",\"Oxygen\",\"Ubuntu\",\"Cantarell\",\"Fira Sans\",\"Droid Sans\",\"Helvetica Neue\",sans-serif !important;\n  font-size: 16px;\n  font-weight: bold;\n  color: ", ";\n"], ["\n  cursor: pointer;\n  font-family: -apple-system,BlinkMacSystemFont,\"Segoe UI\",\"Roboto\",\"Oxygen\",\"Ubuntu\",\"Cantarell\",\"Fira Sans\",\"Droid Sans\",\"Helvetica Neue\",sans-serif !important;\n  font-size: 16px;\n  font-weight: bold;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            React.createElement(Flex, null, socials.map(function (social, index) {
                ...
                if (social.items) {
                    var item = social.items[0];
                    return (
                    // <Dropdown key={social.label} position="top" target={<Icon {...iconProps} mr={mr} />}>
                    // {social.items.map((item) => (
                    React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "textSubtle" },
                        React.createElement(Icon, __assign({}, iconProps, { mr: mr })))
                    // ))}
                    // </Dropdown>
                    );
                }
        ...
        React.createElement(CHIPZBOTTOM, null, "CHIPZ")));
};
...
var StyledPanel = styled.div(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: calc(100vh - 20px);\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 1px solid rgba(255, 255, 255, 0.25);\n    width: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: calc(100vh - 20px);\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 1px solid rgba(255, 255, 255, 0.25);\n    width: ", ";\n  }\n"])), function (_a) {
    ...
    var isPushed = _a.isPushed;
    return (isPushed ? "1px solid rgba(255, 255, 255, 0.25)" : 0);
}, function (_a) {
    var isPushed = _a.isPushed;
...
var injected = new InjectedConnector({ supportedChainIds: [56] });
...
var WalletCard = function (_a) {
    var activate = _a.activate, connector = _a.connector, walletConfig = _a.walletConfig, onDismiss = _a.onDismiss, mb = _a.mb;
...
var ConnectModal = function (_a) {
    var activate = _a.activate, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss }, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, activate: activate, connector: entry.connectorId, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "20px" : "0" })); })));
};
...
var useWalletModal = function (activate, logout, account) {
    var onPresentConnectModal = useModal(React.createElement(ConnectModal, { activate: activate }))[0];
...
var UserBlock = function (_a) {
    var account = _a.account, activate = _a.activate, logout = _a.logout;
    var _b = useWalletModal(activate, logout, account), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, activate = _a.activate, logout = _a.logout; _a.isDark; var toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Logo, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: true, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React.createElement(Flex, null,
                React.createElement(UserBlock, { account: account, activate: activate, logout: logout }),
                profile && React.createElement(Avatar, { profile: profile }))),
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: true, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
